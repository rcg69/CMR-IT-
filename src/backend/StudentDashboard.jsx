...
const StudentDashboard = () => {
    ...
    const fetchAttendance = async () => {
      ...
      try {
        ...
        const res = await fetch(
          `https://cmr-it.onrender.com/api/student/attendance-summary?email=${encodeURIComponent(
            student.email
          )}`
        );
  ...
  useEffect(() => {
    const fetchRecords = async () => {
      ...
      try {
        ...
        const res = await fetch(
          `https://cmr-it.onrender.com/api/student/attendance-records?email=${encodeURIComponent(
            student.email
          )}`
        );
        const data = await res.json().catch(() => ({}));
  ...
  useEffect(() => {
    const fetchProfile = async () => {
      ...
      try {
        ...
        const res = await fetch(
          `https://cmr-it.onrender.com/api/student/profile?email=${encodeURIComponent(
            student.email
          )}`
        );
  ...
  const handleImageUpload = async () => {
    ...
    try {
      ...
      const res = await fetch(
        'https://cmr-it.onrender.com/api/student/profile-image',
